...
namespace MCForge_Redux {
	public class ForgeBot {
		...
		public string nick = "MCForge_Redux";
		//private string server;
		private bool reset = false;
		private byte retries = 0;
		public string usedCmd = "";
		public ForgeBot(string channel, string opchannel, string server) {
			...
			//	return;
			//}
			this.channel = channel.Trim(); this.opchannel = opchannel.Trim(); nick = ("MCForge_Redux"); //this.server = server;
			banCmd = new List<string>();
			if (Server.irc) {
                server = "irc.esper.net";
                channel = "#MCForge_Redux-irc";
                nick = "MCForge_Redux";
