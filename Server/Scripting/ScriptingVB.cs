/*
	Copyright © 2014 MCForge_Redux-Redux Team
...
*/
using System;
namespace MCForge_Redux.Core.Scripting
{
    public sealed class ScriptingVB : ScriptingEngine
    {
        ...
        {
            return "Imports MCForge_Redux" + Environment.NewLine +
                         "'Auto-generated command skeleton class." + Environment.NewLine +
                         Environment.NewLine +
                         "'Use this as a basis for custom commands implemented via the MCForge_Redux scripting framework." + Environment.NewLine +
                         ...
                         "' As a note, MCForge_Redux is designed for .NET 3.5." + Environment.NewLine +

                         Environment.NewLine +
                         "Namespace MCForge_Redux" + Environment.NewLine +
