...
namespace MCForge_Redux
{
    ...
    public class Server
    {
        ...
        public static string SourceURL = "https://github.com/SuperNova-DeadNova/MCForge-Shared";
        public static string UploadsURL = "https://github.com/SuperNova-DeadNova/MCForge-Shared/tree/master/Uploads";
        ...
        /// since BetaCraft doesn't allow MCForge_Redux to connect using its default SoftwareName.
        /// </summary>
        public const string InternalVersion = "5.5.1.4";
        ...
        public static string SoftwareName = "&fMCForge &4R&6e&5d&cu&ex &dV&f.";
        public static string SoftwareName3 = "%26fMCForge %264R%266e%265d%26cu%26ex %26dV%26f.";
        ...
        public static string SoftwareNameVersioned3
        {
            // By default, if SoftwareName gets externally changed, that is reflected in SoftwareNameVersioned too
            get { return fullName ?? SoftwareName3 + " " + Version; }
            set { fullName = value; }
        }
        ...
        public static string name = "[MCForge Redux] Default";
        ...
        public static string ircNick = "MCForge_Redux";
        ...
        public static string opircNick = "MCForge_Redux";
        ...
        public static string opircPassword = "";
            ...
            Log("Starting Server");
            {
                ...
                if (!File.Exists("MySql.Data.dll"))
                {
                    ...
                    try
                    {
                        ...
                        {
                            WEB.DownloadFile("https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/MySql.Data.dll", "MySql.Data.dll");
                        }
                        if (File.Exists("MySql.Data.dll"))
                        {
                ...
                if (!File.Exists("System.Data.SQLite.dll"))
                {
                    ...
                    try
                    {
                        using (WebClient WEB = new WebClient())
                        {
                            WEB.DownloadFile("https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/System.Data.SQLite.dll", "System.Data.SQLite.dll");
                        }
                        if (File.Exists("System.Data.SQLite.dll"))
                        {
                ...
                if (!File.Exists("sqlite3.dll"))
                {
                    ...
                    try
                    {
                        using (WebClient WEB = new WebClient())
                        {
                            WEB.DownloadFile("https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/sqlite3.dll", "sqlite3.dll");
                        }
                        if (File.Exists("sqlite3.dll"))
                        {
                ...
                if (!File.Exists("Newtonsoft.Json.dll"))
                {
                    ...
                    try
                    {
                        using (WebClient WEB = new WebClient())
                        {
                            WEB.DownloadFile("https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/Newtonsoft.Json.dll", "Newtonsoft.Json.dll");
                        }
                        if (File.Exists("Newtonsoft.Json.dll"))
                        {
	  ...
	  UseTextures = true;          
        ...
        public static void UpdateGlobalSettings()
        {
            try
            {
                ...
                using (var client = new WebClient())
                {
                    try
                    {
                        jason = JArray.Parse(client.DownloadString("https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/gcbanned.txt"));
                    }
                    catch { }
                }
                if (jason != null)
        ...
        public void UpdateStaffList()
        {
            try
            {
                ...
                using (WebClient web = new WebClient())
                {
                    string[] result = web.DownloadString("https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/devs.txt").Split(new string[] { Environment.NewLine, "\n" }, StringSplitOptions.None);
