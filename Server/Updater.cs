...
using static MCForge_Redux.Player;
...
namespace MCForge_Redux.Gui
{
    public static class Updater
    {
        ...
        public const string BaseURL = "https://github.com/RandomStrangers/MCForge_Redux/blob/master/";
        public const string UploadsURL = "https://github.com/RandomStrangers/MCForge_Redux/raw/master/Uploads/";
        const string CurrentVersionURL = UploadsURL + "current_version.txt";
        const string dllURL = UploadsURL + "MCForge_Redux.dll";
        ...
        const string guiURL = UploadsURL + "MCForge_Redux.exe";
                ...
                if (Server.autoupdate == true || p != null)
                {
                    ...
                    void PerformUpdate()
                    {
                        try
                        {
                            ...
                            //    SW.WriteLine("if exist MCForge_Redux.dll.backup (erase MCForge_Redux.dll.backup)");
                            //    SW.WriteLine("if exist MCForge_Redux.dll (rename MCForge_Redux.dll MCForge_Redux.dll.backup)");
                            //    SW.WriteLine("if exist MCForge_Redux.new (rename MCForge_Redux.new MCForge_Redux.dll)");
                            ...
                            //    SW.WriteLine("kill $2");
                            //    SW.WriteLine("rm MCForge_Redux.dll.backup");
                            //    SW.WriteLine("mv MCForge_Redux.dll MCForge_Redux.dll_.backup");
