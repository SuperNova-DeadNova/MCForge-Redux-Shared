...
using MCForge_Redux.Core;

namespace MCForge_Redux.Gui.Popups {
    public partial class PortTools : Form {
        ...
        private void linkHelpForward_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e) {
            try { Process.Start("https://github.com/MCForge_Redux/MCForge_Redux-Vanilla/wiki/Setup%20MCForge%205.5.0.2"); }
            catch { }
        }
