...
namespace MCForge_Redux.Gui {
    public partial class Window : Form {
        ...
        private void Window_Load(object sender, EventArgs e) {
            ...
            //thisWindow = this;
            MaximizeBox = false;
            this.Text = "Starting MCForge_Redux...";
            this.Show();
            this.BringToFront();
            ...
            notifyIcon1.Text = ( "MCForge_Redux Server" ).Truncate(64);
        ...
        void SettingsUpdate() {
            ...
            if ( txtLog.InvokeRequired ) {
                ...
                this.Text = "MCForge_Redux " + Server.Version;
                notifyIcon1.Text = ("MCForge_Redux Server").Truncate(64);
            }
        }
        ...
        private void Window_FormClosing(object sender, FormClosingEventArgs e) {
            if (e.CloseReason == CloseReason.WindowsShutDown) {
                MCForge_Redux.Gui.Program.ExitProgram(false);
            }
        ...
        private void Restart_Click(object sender, EventArgs e) {
            if ( MessageBox.Show("Are you sure you want to restart?", "Restart", MessageBoxButtons.OKCancel) == DialogResult.OK ) {
                MCForge_Redux.Gui.Program.ExitProgram(true);
            }
        ...
        private void button1_Click_1( object sender, EventArgs e ) {
            try {
                ...
                MessageBox.Show( "Failed to open browser.", "MCForge_Redux Redux" );
            }
        }
    }
}
