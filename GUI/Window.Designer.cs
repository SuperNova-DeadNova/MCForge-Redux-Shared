...
namespace MCForge_Redux.Gui
{
    public partial class Window
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtCommandsUsed = new MCForge_Redux.Gui.AutoScrollTextBox();
            this.txtLog = new MCForge_Redux.Gui.Components.ColoredTextBox();
            this.LogsTxtBox = new MCForge_Redux.Gui.Components.ColoredTextBox();
            this.PlayersTextBox = new MCForge_Redux.Gui.AutoScrollTextBox();
            this.txtGlobalLog = new MCForge_Redux.Gui.AutoScrollTextBox();
            this.txtOpLog = new MCForge_Redux.Gui.AutoScrollTextBox();
            this.txtAdminLog = new MCForge_Redux.Gui.AutoScrollTextBox();
