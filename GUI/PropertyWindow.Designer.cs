...
namespace MCForge_Redux.Gui
{
    partial class PropertyWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip.SetToolTip( this.comboBoxProtection, "When set to Mod, MCForge_Redux Moderators AND Developers are protected. When set to Dev" +
                    ", MCForge_Redux Developers only are protected. When set to Off, MCforge staff are not " +
                    "protected." );
            // 
            // label91
            // 
            ...
            this.toolTip.SetToolTip( this.label91, "When set to Mod, MCForge_Redux Moderators AND Developers are protected. When set to Dev" +
                    ", MCForge_Redux Developers only are protected. When set to Off, MCforge staff are not " +
                    "protected." );
            // 
            // tabPage5
            ...
            this.groupBox7.Text = "MCForge_Redux Staff Protection";
            // 
            // groupBox15
            // 
