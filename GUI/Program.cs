...
namespace MCForge_Redux.Gui
{
    public static class Program
    {
        ...
        private static string CurrentVersionFile = "https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/current_version.txt";
        private static string DLLLocation = "https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/MCForge_Redux_.dll";
        private static string ChangelogLocation = "https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/changelog.txt";
        private static string EXELocation = "https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/MCForge_Redux.exe";
        private static string CLIEXELocation = "https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/Uploads/MCForge_ReduxCLI.exe";
        private static string RevisionList = "https://github.com/SuperNova-DeadNova/MCForge-Shared/raw/master/revs.txt";
        ...
        public static void Main(string[] args)
        {
            ...
            if (Process.GetProcessesByName("MCForge_Redux").Length != 1)
            {
                foreach (Process pr in Process.GetProcessesByName("MCForge_Redux"))
                {
        ...
        remake:
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Application.Run(new MCForge_Redux.Gui.Window());
                }
                if (args[0].Contains("cli"))
                {
                    ...
                    Console.Title = Server.name + " - MCForge Redux " + Server.Version;
                    usingConsole = true;
                    handleComm();
                    ...
                    if (availableUpdateVersion != null)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                Console.WriteLine("Update using the file at " + DLLLocation + " and placing it over the top of your current MCForge_Redux_.dll!");
                                Console.WriteLine("Also update using the file at " + EXELocation + " and placing it over the top of your current MCForge_Redux.exe");
                                Console.WriteLine("Also update using the file at " + CLIEXELocation + " and placing it over the top of your current MCForge_ReduxCLI.exe");
        ...
        public static void PerformUpdate()
        {
            try
            {
                ...
                if (!Server.mono)
                {
                    ...
                    SW.WriteLine("if exist MCForge_Redux_.dll.backup (erase MCForge_Redux_.dll.backup)");
                    SW.WriteLine("if exist MCForge_Redux_.dll (rename MCForge_Redux_.dll MCForge_Redux_.dll.backup)");
                    SW.WriteLine("if exist MCForge_Redux_.new (rename MCForge_Redux_.new MCForge_Redux_.dll)");
                    SW.WriteLine("start MCForge_Redux.exe");
                }
                else
                {
                ...
                if (File.ReadAllLines("Update.sh")[0] != "#Version 2")
                    ...
                    SW.WriteLine("kill $2");
                    SW.WriteLine("rm MCForge_Redux_.dll.backup");
                    SW.WriteLine("mv MCForge_Redux_.dll MCForge_Redux_.dll_.backup");
                    SW.WriteLine("wget " + DLLLocation);
                    SW.WriteLine("mono MCForge_Redux.exe");
                }
               ...
               int vers = int.Parse(verscheck.Split('.')[0]);
                try
                {
                    ...
                    if (File.Exists("MCForge_Redux_.update"))
                        File.Delete("MCForge_Redux_.update");
                    if (File.Exists("MCForge_Redux.update"))
                        File.Delete("MCForge_Redux.update");
                    if (File.Exists("MCForge_ReduxCLI.update"))
                        File.Delete("MCForge_ReduxCLI.update");
                    if (File.Exists("Update.bat"))
                ...
                WebClient Client = new WebClient();
                Client.DownloadFile(DLLLocation, "MCForge_Redux_.update");
                Client.DownloadFile(EXELocation, "MCForge_Redux.update");
                Client.DownloadFile(CLIEXELocation, "MCForge_ReduxCLI.update");
               ...
               //File.WriteAllBytes("Updater.exe", MCForge_Redux.Properties.Resources.Updater);
                if (!usingConsole)
        ...
        static public void ExitProgram(bool AutoRestart)
        {
            ...
            new Thread(new ThreadStart(delegate
            {
                /*try
                {
                    if (MCForge_Redux.Gui.Window.thisWindow.notifyIcon1 != null)
                    {
                        MCForge_Redux.Gui.Window.thisWindow.notifyIcon1.Icon = null;
                        MCForge_Redux.Gui.Window.thisWindow.notifyIcon1.Visible = false;
                        MCForge_Redux.Gui.Window.thisWindow.notifyIcon1.Dispose();
                    }
                }
                catch { }
                */
