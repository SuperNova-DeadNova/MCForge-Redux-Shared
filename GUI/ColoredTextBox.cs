...
using MCForge_Redux.Gui.Utils;

//MCForge_Redux 6 Preview :D

namespace MCForge_Redux.Gui.Components {

    /// <summary>
    /// A rich text box, that can parse Minecraft/MCForge_Redux color codes.
    /// </summary>
