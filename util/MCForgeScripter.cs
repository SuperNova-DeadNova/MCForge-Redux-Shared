...
namespace MCForge_Redux.Util {

    public class MCForgeScripter {

        private static readonly CompilerParameters _settings = new CompilerParameters(new [] {"mscorlib.dll", "MCForge_Redux.dll", "MCForge_Redux.exe", "MCForgeCLI.exe"}) {
