...
namespace MCForge_Redux.Commands
{
    public class CmdUpdate : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            {
                if (p == null || p.group.Permission > defaultRank) MCForge_Redux.Gui.Program.UpdateCheck(false, p);
            ...
            {
                if (p == null || p.group.Permission > defaultRank) MCForge_Redux.Gui.Program.PerformUpdate();
                else Player.SendMessage(p, "Ask an " + Group.findPerm(defaultRank).name + "+ to do it!");
            }
        }
